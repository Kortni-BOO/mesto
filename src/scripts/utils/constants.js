export const initialCards = [
    ...
    },
    {
        name: "Мурманск",
        link:
            "https://travel-or-die.ru/wp-content/uploads/2018/07/Ekskursiya-iz-Murmanska-Severnoe-siyanie-.jpg",
    },
    {
        name: "Иваново",
        link:
...
export const popupOpenButtonAdd = document.querySelector(
    ".profile__button-add"
);
...
export const nameInput = document.querySelector(
    ".popup__input_assignment_author-name"
);
export const jobInput = document.querySelector(
    ".popup__input_assignment_author-job"
);
...
export const placeName = document.querySelector(
    ".popup__input_assignment_place-name"
);
export const placeLink = document.querySelector(
    ".popup__input_assignment_place-link"
);
...
export const popupOpenAvatar = document.querySelector(
    ".profile__avatar-overlay"
);
export const popupAv = document.querySelector(
    ".popup__input_assigment_avatar-edit"
);
export const popupRemove = document.querySelector(
    ".popup_profile-image-delete"
);
export const popupFormUpdate = document.querySelector(
    ".popup__form_profile-avatar-edit"
);
