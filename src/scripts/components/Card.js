...
export default class Card {
    constructor({data, handleCardClick, handleDeleteButtonClick, addLike, removeLike}, elementTemplate, userId) {
    ...
    addButtonLike() {
        this._element.querySelector('.element__button-like').classList.add('element__button-like__active');
        this._addLike();
    }

    removeButtonLike() {
        this._element.querySelector('.element__button-like').classList.remove('element__button-like__active');
        this._removeLike();
    }
    ...
    countLike(data) {
        this._element.querySelector('.element__count').textContent = String(data.likes.length);
    }
    ...
    _setEventListeners() {
        ...
        .addEventListener('click', () => this._handleDeleteButtonClick(this._data));
