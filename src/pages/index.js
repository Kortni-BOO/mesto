...
const popupPhotoBig = new PopupWidthImage({
    popupSelector: bigPhoto,
    link: popupPhoto,
    name: popupPhotoName,
});

const popupUpdateUser = new PopupWithForm({
    popupSelector: popupUpdate,
    handleFormSubmit: () => {
        ...
        api.editAvatarUser({ avatar: userAvatar })
            ...
            .catch((err) =>
                console.log(`Ошибка при обновлении аватфра: ${err}`)
            )
            .finally(() => {
